...
const TOAST_ICONS = {
  error: IconCircleWarningOutlineDuo18,
  info: IconCircleInfoOutlineDuo18,
  loading: IconLoaderOutlineDuo18,
  success: IconCircleCheckOutlineDuo18,
  warning: IconTriangleWarningOutlineDuo18,
} as const;

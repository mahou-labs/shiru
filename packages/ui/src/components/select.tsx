  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon data-slot="select-icon">
        <IconChevronExpandYOutlineDuo18 className="-me-1 size-4 opacity-72" />
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          >
            <IconChevronUpOutlineDuo18 className="relative size-4" />
          </SelectPrimitive.ScrollUpArrow>
          <span className="relative block h-full rounded-lg border border-border bg-popover bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-lg dark:not-in-data-[slot=group]:bg-clip-border">
          ...
          >
            <IconChevronDownOutlineDuo18 className="relative size-4" />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
    </SelectPrimitive.Portal>

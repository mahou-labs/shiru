      ...
      <SheetViewport inset={inset} side={side}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            side === "bottom" &&
              "row-start-2 border-t border-border data-ending-style:translate-y-8 data-starting-style:translate-y-8",
            side === "top" &&
              "data-ending-style:-translate-y-8 data-starting-style:-translate-y-8 border-b border-border",
            side === "left" &&
              "data-ending-style:-translate-x-8 data-starting-style:-translate-x-8 w-[calc(100%-(--spacing(12)))] max-w-md border-e border-border",
            side === "right" &&
              "col-start-2 w-[calc(100%-(--spacing(12)))] max-w-md border-s border-border data-ending-style:translate-x-8 data-starting-style:translate-x-8",
            inset && "before:hidden sm:rounded-2xl sm:border sm:border-border",
            className,
          )}

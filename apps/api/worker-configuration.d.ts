/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a4e460c2751065f03807825f434e26f8)
// Runtime types generated with workerd@1.20260317.1 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BuilderSandbox";
	}
	interface Env {
		DOCS_SOURCE: R2Bucket;
		DOCS_DIST: R2Bucket;
		DB: D1Database;
		...
		BUILDER_SANDBOX: DurableObjectNamespace<import("./src/index").BuilderSandbox>;
		PUBLISH_DOCS: Workflow<Parameters<import("./src/index").PublishDocsWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOG_PUBLIC_KEY" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ZONE_ID" | "GITHUB_TOKEN" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_WEBHOOK_SECRET" | "ENVIRONMENT" | "DASHBOARD_URL" | "SITE_URL" | "BETTER_AUTH_URL">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 08853d97b49ba60aba57917a4cc076e8)
// Runtime types generated with workerd@1.20260317.1 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ENVIRONMENT: "staging";
		DASHBOARD_URL: "https://staging-dashboard.shiru.sh";
		SITE_URL: "https://shiru.sh";
		BETTER_AUTH_URL: "https://staging-api.shiru.sh";
		POSTHOG_PUBLIC_KEY: "phc_hdbwwJWoeHfDnlt0Jgv7GB8UhAPVvTLaz6hg0DKXZyR";
	...
	interface ProdEnv {
		...
		DASHBOARD_URL: "https://dashboard.shiru.sh";
		SITE_URL: "https://shiru.sh";
		BETTER_AUTH_URL: "https://api.shiru.sh";
		POSTHOG_PUBLIC_KEY: "phc_hdbwwJWoeHfDnlt0Jgv7GB8UhAPVvTLaz6hg0DKXZyR";
		BETTER_AUTH_SECRET: string;
		RESEND_API_KEY: string;
		POLAR_ACCESS_TOKEN: string;
	...
	interface Env {
		...
		DASHBOARD_URL: "https://staging-dashboard.shiru.sh" | "https://dashboard.shiru.sh" | "http://localhost:3001";
		SITE_URL: "https://shiru.sh" | "http://localhost:3002";
		BETTER_AUTH_URL: "https://staging-api.shiru.sh" | "https://api.shiru.sh" | "http://localhost:3000";
		POSTHOG_PUBLIC_KEY: "phc_hdbwwJWoeHfDnlt0Jgv7GB8UhAPVvTLaz6hg0DKXZyR";
		BETTER_AUTH_SECRET: string;
		RESEND_API_KEY: string;
		POLAR_ACCESS_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DASHBOARD_URL" | "SITE_URL" | "BETTER_AUTH_URL" | "POSTHOG_PUBLIC_KEY" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ZONE_ID">> {}
}

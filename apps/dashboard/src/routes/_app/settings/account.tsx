...
const themeConfig: Record<
  ThemeOption,
  { icon: typeof IconSunOutlineDuo18; label: string; description: string }
> = {
  light: { icon: IconSunOutlineDuo18, label: "Light", description: "A clean, bright appearance" },
  dark: {
    icon: IconDarkModeOutlineDuo18,
    label: "Dark",
    description: "Easy on the eyes in low light",
  },
  system: {
    icon: IconLaptopOutlineDuo18,
    label: "System",
              ...
              return (
                ...
                >
                  <div className="flex w-full items-center justify-between">
                    ...
                    {isActive && <IconCheckOutlineDuo18 className="size-4 text-primary" />}
                  </div>

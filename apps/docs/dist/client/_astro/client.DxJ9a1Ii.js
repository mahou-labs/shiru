...
` +
    ...
    function Wa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return a === y
          ...
          : t !== null &&
              (t.elementType === a ||
                (typeof a == `object` && a && a.$$typeof === C && Fa(a) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case _:
              return (
                (n = Si(t.type, t.key, t.props, null, e.mode, n)), Ha(n, t), (n.return = e), n
              );
            case v:
    ...
    function Fc(e, t, n) {
      switch (t.tag) {
        ...
        case 19:
          var i = (e.flags & 128) != 0;
          if (
            ((r = (n & t.childLanes) !== 0), (r ||= (sa(e, t, n, !1), (n & t.childLanes) !== 0)), i)
          ) {
    ...
    function Hc(e, t, n) {
      ...
      switch ((Vi(t), t.tag)) {
        ...
        case 5:
          ...
          return (
            B(t), Rc(t, t.type, e === null ? null : e.memoizedProps, t.pendingProps, n), null
          );
        case 6:
    ...
    function hl(e) {
      switch (e.tag) {
        ...
        case 22:
          return (
            (e = e.stateNode), (t = e._retryCache), t === null && (t = e._retryCache = new ol()), t
          );
        default:
...
`,
  ...
  l = n(),
  u = (0, l.memo)(
    ({ value: e, name: t, hydrate: n = !0 }) =>
      e == null || e.trim() === ``
        ? null
        : (0, l.createElement)(n ? `astro-slot` : `astro-static-slot`, {
            name: t,
...
function d(e) {
  for (const t in e) if (t.startsWith(`__reactContainer`)) return t;
}
let f = { class: `className`, for: `htmlFor` },
  p = 0;
function m(e, t, n) {
  t === void 0 && ((p += 1), (t = p), (n = 0));
  const r = {};
  for (const t of e.attributes) {
    const e = f[t.name] || t.name;
    r[e] = t.value;
  }
  if (((r.key = `${t}-${n}`), e.firstChild === null)) return (0, l.createElement)(e.localName, r);
  let i = 0;
  return (0, l.createElement)(
    ...
    Array.from(e.childNodes)
      .map((e) => {
        ...
        if (e.nodeType === Node.ELEMENT_NODE) return ((i += 1), m(e, t, i));
      })
      .filter((e) => !!e),
  );
}
function h(e, t) {
  if (t && e) {
    ...
    n.innerHTML = e;
    for (const e of n.content.children) t.push(m(e));
    return t;
  } else if (e) return (0, l.createElement)(u, { value: e });
  else return;
}
const g = new WeakMap(),
  _ = (e, t) => {
    let n = g.get(e);
    return (n || ((n = t()), g.set(e, n)), n);
  },
  v =
    (e) =>
    (t, n, { default: r, ...i }, { client: a }) => {
      if (!e.hasAttribute(`ssr`)) return;
      let o = e.getAttribute(`data-action-key`),
        s = e.getAttribute(`data-action-name`),
        f = e.getAttribute(`data-action-result`),
        p = o && s && f ? [JSON.parse(f), o, s] : void 0,
        m = { identifierPrefix: e.getAttribute(`prefix`), formState: p };
      for (let [e, t] of Object.entries(i)) n[e] = (0, l.createElement)(u, { value: t, name: e });
      let g = (0, l.createElement)(t, n, h(r, e.hasAttribute(`data-react-children`))),
        v = d(e);
      if ((v && delete e[v], a === `only`))
        return (0, l.startTransition)(() => {
          _(e, () => {
            let t = (0, c.createRoot)(e);
            return (e.addEventListener(`astro:unmount`, () => t.unmount(), { once: !0 }), t);
          }).render(g);
        });
      (0, l.startTransition)(() => {
        _(e, () => {
          let t = (0, c.hydrateRoot)(e, g, m);
          return (e.addEventListener(`astro:unmount`, () => t.unmount(), { once: !0 }), t);
        }).render(g);
      });
    };

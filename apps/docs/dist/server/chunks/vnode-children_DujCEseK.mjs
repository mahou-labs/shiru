...
import { r as __toESM } from "./chunk_B-gkxaTK.mjs";
import { t as require_react } from "./react_hEShQL-y.mjs";
//#region ../../node_modules/.bun/ultrahtml@1.6.0/node_modules/ultrahtml/dist/index.js
...
function I(e) {
  ...
  if (e) {
    ...
    for (let c = 0; c < e.length; c++) {
      ...
      i === "none"
        ? b.test(d)
          ? (r && ((t[r] = n), (r = void 0), (n = "")), (a = c), (i = "key"))
          : d === "=" && r && (i = "value")
        : i === "key"
          ? b.test(d) || ((r = e.substring(a, c)), d === "=" ? (i = "value") : (i = "none"))
          : d === l && c > 0 && e[c - 1] !== "\\"
            ? l && ((n = e.substring(a, c)), (l = void 0), (i = "none"))
            : (d === '"' || d === "'") && !l && ((a = c + 1), (l = d));
    }
...
function P(e) {
  ...
  let g = 0;
  function h() {
    ((a = t.substring(g, o.lastIndex - n[0].length)),
      a &&
        r.children.push({
          type: 2,
          value: a,
    ...
    if (
      ...
      if ((h(), x.has(r.name))) {
        ...
        ((s = {
          ...
          u.push(s),
          s.parent.children.push(s),
          (n[4] && n[4].indexOf("/") > -1) || D.has(s.name)
            ? ((s.loc[1] = s.loc[0]), (s.isSelfClosingTag = !0))
            : (r = s));
    else
      (h(),
        n[2] + "" === r.name
          ? ((s = r),
            ...
            (a = t.substring(s.loc[0].end, s.loc[1].start)),
            s.children.length === 0 &&
              s.children.push({
                type: 2,
                value: a,
...
//#endregion
//#region ../../node_modules/.bun/@astrojs+react@5.0.2+a751bdad789b034d/node_modules/@astrojs/react/dist/vnode-children.js
let ids = 0;
function convert(children) {
  const doc = P(children.toString().trim());
  const id = ids++;
  let key = 0;

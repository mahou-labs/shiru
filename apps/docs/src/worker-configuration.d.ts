/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ce6cc5ec3faa3a752378b224a76baa55)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "VITE_API_URL" | "VITE_POSTHOG_KEY" | "VITE_POSTHOG_HOST">
  > {}
}
